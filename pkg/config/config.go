...
type HostExecConfig struct {
	ToolConfig `envPrefix:"PICOCLAW_TOOLS_HOST_EXEC_"`
}

type RootExecConfig struct {
	ToolConfig `envPrefix:"PICOCLAW_TOOLS_ROOT_EXEC_"`
}
...
type ToolsConfig struct {
	...
	HostExec        HostExecConfig     `json:"host_exec"         yaml:"-"                                                       envPrefix:"PICOCLAW_TOOLS_HOST_EXEC_"`
	RootExec        RootExecConfig     `json:"root_exec"         yaml:"-"                                                       envPrefix:"PICOCLAW_TOOLS_ROOT_EXEC_"`
...
func (t *ToolsConfig) IsToolEnabled(name string) bool {
	...
	case "host_exec":
		return t.HostExec.Enabled
	case "root_exec":
		return t.RootExec.Enabled
	case "media_cleanup":
