...
func NewAgentInstance(
	...
	if cfg.Tools.IsToolEnabled("host_exec") {
		toolsRegistry.Register(tools.NewHostExecTool())
	}
	if cfg.Tools.IsToolEnabled("root_exec") {
		toolsRegistry.Register(tools.NewRootExecTool())
	}
